...
const char* ssid     = "VIVOFIBRA-AEC0-5G"; //MUDAR DE ACORDO COM O NOME DA REDE
const char* password = "591A55F3CF"; //MUDAR DE ACORDO COM A SENHA DA REDE
//chatgpt api
const char* chatgpt_token = "INSERT TOKEN HERE"; //colocar o token q ta no zap zap
